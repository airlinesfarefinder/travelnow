...
<body>
    ...
    <div class="carousel-item active">
        <div class="testimonial-content">
            <div class="stars">★★★★★</div>
            <p>Travel Now Deals was fast, easy, and completely stress-free. They offer a wide range of vehicles from top rental companies, so it was simple to find the perfect ride for my trip. Everything went smoothly from booking to pickup.
            </p>
    ...
    <div class="carousel-item">
        <div class="testimonial-content">
            <div class="stars">★★★★★</div>
            <p>
               Travel Now Deals makes renting a car so simple and reliable. I found better rates than anywhere else, and the range of vehicles was exactly what I needed. Their customer service was responsive and kind, which made the whole process even better.
            </p>
