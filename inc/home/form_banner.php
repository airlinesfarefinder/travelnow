...
@keyframes slideBackground {
  0%, 33.32% {
    background-image: url('./images/images/3997404.jpg');
  }
  33.33%, 66.65% {
    background-image: url('./images/cruise/cruise-banner.jpg');
  }
  66.66%, 100% {
    background-image: url('./images/carRental/car_banner.jpg');
  }
}
