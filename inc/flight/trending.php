                ...
                <div class="trending_item_container">
                    <div class="tre_img_wrap">
                        <div class="tre_img"  style=" 
                          background-image: url('./images/images/person-traveling-enjoying-their-vacation.jpg');"
            ...
            <div class="col-sm-4">
                <div class="trending_item_container">
                    <div class="tre_img_wrap">
                        <div class="tre_img"
                        style=" 
                          background-image: url('./images/images/idyllic-tropical-island-resort-with-turquoise-waters-wooden-jetty.jpg');"
                        >
                            <div class="middle_dark_overlay"></div>
            ...
            <div class="col-sm-4">
                <div class="trending_item_container">
                    <div class="tre_img_wrap">
                        ...
                        style=" 
                          background-image: url('./images/images/path-with-access-sea-seascape.jpg');"
                        >
                            <div class="middle_dark_overlay"></div>
